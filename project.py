...
engine = create_engine('sqlite:///itemcatlouge.db', listeners=[ForeignKeysListener()])
...
def categoryItemsJSON(categoey_id):
...
def categoryJSON():
    ...
    return jsonify(categroies=[r.serialize for r in categroies])
